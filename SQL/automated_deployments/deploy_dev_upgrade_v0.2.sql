/************************************************************************************
 Filename   : deploy_dev_upgrade_v0.2.sql
 Author     :
 Purpose    : Automated upgrade script for the Database Logging Module database, this is intended for use on the development environment
...
SELECT 'DB_log_upgrade_dev_v0.2_' || TO_CHAR( SYSDATE, 'yyyymmdd' ) spool_fname FROM DUAL;
