/************************************************************************************
 Filename   : deploy_dev_rollback_v0.2.sql
 Author     :
...
SELECT 'DB_log_rollback_dev_v0.2_' || TO_CHAR( SYSDATE, 'yyyymmdd' ) spool_fname FROM DUAL;
...
@rollback/DB_log_DDL_DML_rollback_v0.2.sql
