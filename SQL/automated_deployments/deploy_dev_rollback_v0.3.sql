/************************************************************************************
 Filename   : deploy_dev_rollback_v0.3.sql
 Author     :
 Purpose    : Automated rollback script for the Database Logging Module database, this is intended for use on the development environment
...
SELECT 'DB_log_rollback_dev_v0.3_' || TO_CHAR( SYSDATE, 'yyyymmdd' ) spool_fname FROM DUAL;
...
@rollback/DB_log_DDL_DML_rollback_v0.3.sql
